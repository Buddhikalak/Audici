...
import us.audici.umgt.Exceptions.FileNotFoundException;
import us.audici.umgt.Exceptions.StorageException;
...
public class FileSystemStorageServiceImpl implements StorageService {
    ...
    public String store(MultipartFile file) {
        String filename = CommonsUtil.getSQLTimeStamp()+""+StringUtils.cleanPath(file.getOriginalFilename());
        try {
            if (file.isEmpty()) {
